...
| <a name="input_client_tags"></a> [client\_tags](#input\_client\_tags) | List of network tags to attach to DAOS client instances | `list(any)` | <pre>[<br>  "daos-client"<br>]</pre> | no |
...
| <a name="input_server_tags"></a> [server\_tags](#input\_server\_tags) | List of network tags to attach to DAOS server instances | `list(any)` | <pre>[<br>  "daos-server"<br>]</pre> | no |
