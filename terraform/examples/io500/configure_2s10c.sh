...
# ------------------------------------------------------------------------------
DAOS_SERVER_BASE_NAME="daos-server-1-2"
DAOS_CLIENT_BASE_NAME="daos-client-1-2"
if [[ ! -z $ID ]]
then
...
export TF_VAR_server_os_family="daos-server-1-2-centos-7"
# Clients
...
export TF_VAR_client_os_family="daos-client-1-2-hpc-centos-7"
